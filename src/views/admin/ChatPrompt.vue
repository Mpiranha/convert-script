<template>
  <div class="container-fluid px-0">
    <div class="flex-main-wrap">
      <sidebar :user-name="this.$store.state.user.first_name" current-active="audio-language"></sidebar>
            ...
            <div class="sec-padding">
              <div class="
                ...
                <div class="d-flex align-items-center">
                  <button @click="clearField" class="btn btn-create" v-b-modal.modal-new-language>
                    <span>+</span>
                    Add New
                  </button>
                </div>
                ...
                <table v-else class="table table-custom">
                    ...
                    <tr v-for="result in searchResult" :key="result.id">
                      ...
                      <td>
                        <dropdown-tool @edit-clicked="openEditModal(result.id, {
                          ...
                          " @delete-proceed="deleteLanguage(result.id)" delete-what="Language">
                        </dropdown-tool>
                      </td>
                    </tr>
                  </tbody>
                  <tbody v-else-if="languages && searchKey.length < 1">
                    <tr v-for="language in languages" :key="language.id">
                      ...
                      <td>
                        <dropdown-tool @edit-clicked="openEditModal(language.id, {
                          name: language.name,
                        })
                          " @delete-proceed="deleteLanguage(language.id)" delete-what="Language">
                        </dropdown-tool>
                      </td>
                    </tr>
                  </tbody>
              ...
              <div class="d-flex justify-content-center">
                <b-pagination v-model="currentPage" :total-rows="languageLength" :per-page="perPage"
    ...
    <b-modal :hide-header="true" id="modal-new-language" centered size="md" :hide-footer="true"
      ...
      <b-form-group label="Name">
        <b-form-input id="name" v-model="languageData.name" type="text" class="input-table">
        </b-form-input>
      </b-form-group>

      <b-form-group label="Prompt">
        <b-form-textarea id="name" v-model="languageData.prompt" type="text" class="input-table" rows="4">
        </b-form-textarea>
      </b-form-group>
      ...
      <div class="d-flex justify-content-end">
        <b-button @click="$bvModal.hide('modal-new-language')" class="close-modal">Close</b-button>
        <b-button @click="triggerEdit ? editLanguage(editId, languageData) : addLanguage()
...
export default {
  ...
  methods: {
    ...
    addLanguage() {
      ...
      this.$store
        .dispatch("addLanguage", this.languageData)
        .then((res) => {
          console.log(res);
          this.getAllLanguages();
          this.languageData = {
